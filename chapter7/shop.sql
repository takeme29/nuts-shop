drop database if exists takemura_shop;
create database takemura_shop default character set utf8 collate utf8_general_ci;
grant all on takemura_shop.* to 'takemura-megumi'@'localhost' identified by 'Wert3333-';
use takemura_shop;
